          ...
          {LANGUAGES.map((lang) => (
            <li key={lang.code}>
              <button
                ...
                className={`
                  w-full text-left px-3 py-2 text-sm font-medium whitespace-nowrap
                  transition-colors
                  ${
          ...
          <div className="hidden sm:flex items-center gap-[14px]">
            <NavLink
              ...
              className="
                ...
                rounded-full border border-[#1eb394]
                bg-[#126b59] hover:bg-[#0d5143]
                px-4 py-2
                font-medium text-sm leading-[1.4] text-white whitespace-nowrap
                transition-colors
              "
            >
              Connexion
