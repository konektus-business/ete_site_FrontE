...
// Main posts (appear in "Tous les articles")
const MAIN_POSTS = [
...
// ---- Hero, PostCard, BlogGrid, Newsletter, and Blog export remain unchanged ----
// (they are exactly as in the original, but we'll include them for completeness)
