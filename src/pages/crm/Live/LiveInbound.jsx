...
import { inboundWidgetsConfig } from '../../../config/liveWidgets';
import LiveWidgetsSection from '../../../components/live/LiveWidgetsSection';

export default function LiveInbound() {
  const { data, history, loading } = useLiveData(inboundWidgetsConfig);
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4">
      <div className="flex items-center gap-2 mb-4">
        <ArrowDownCircle className="w-5 h-5 text-[#1EB394]" />
        <h5 className="text-sm font-semibold text-gray-800">Appels entrants</h5>
