...
export default function AddSupUser({ onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setToast({ message: 'Super-utilisateur créé avec succès', type: 'success' });
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="flex items-center gap-3 mt-6 pt-5 border-t border-gray-100">
            <Button type="submit" variant="primary" disabled={loading}>{loading ? 'Création...' : "Créer le super-utilisateur"}</Button>
